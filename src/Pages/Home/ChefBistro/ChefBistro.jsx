...
const ChefBistro = () => {
    return (
        <div className='my-20 p-10 lg:px-20 lg:py-36 bg-[url("https://i.ibb.co/M5pz42xf/chef-service.jpg")] bg-cover bg-no-repeat bg-center bg-black/60 bg-blend-overlay bg-fixed flex justify-center items-center'>
