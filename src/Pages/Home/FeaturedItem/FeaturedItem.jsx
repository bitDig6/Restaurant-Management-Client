...
const FeaturedItem = () => {
    ...
    return (
        <section className='w-4/5 mx-auto my-20 space-y-10'>
            <SectionTitle subTitle="Check it out" title="featured recipe"></SectionTitle>
            <div className='p-10 lg:p-20 bg-black/60 bg-[url("https://i.ibb.co/nqTWL6WX/featured.jpg")] bg-no-repeat bg-cover bg-blend-overlay flex flex-col gap-10 lg:flex-row items-center justify-center'>
                <figure>
                ...
                <div className='space-y-4'>
                    ...
                    <button className='btn md:btn-lg shadow-neutral shadow-xl'>Read More</button>
                </div>
            </div>
        </section>
    );
